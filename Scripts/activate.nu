...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\NVIT\Desktop Based Application Using Thinter'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\NVIT\Desktop Based Application Using Thinter\Scripts\deactivate.nu'
